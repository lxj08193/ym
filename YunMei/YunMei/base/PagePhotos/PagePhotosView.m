...
- (id)initWithFrame:(CGRect)frame withDataSource:(id<PagePhotosDataSource>)_dataSource {
    if ((self = [super initWithFrame:frame])) {
		...
		pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, frame.size.height - pageControlHeight, 100, pageControlHeight)];
...
//{
//    NSTimer *timer =  [NSTimer scheduledTimerWithTimeInterval:time target:self selector:@selector(Scroll:) userInfo:nil repeats:YES];
//}
//
//-(void)Scroll:(id *)sender
//{
//    currentPage++;
//    if(currentPage>=[dataSource numberOfPages])
//    {
//        currentPage =0;
//    }
