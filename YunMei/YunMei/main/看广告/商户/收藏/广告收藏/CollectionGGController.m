...
@interface CollectionGGController ()

@end

@implementation CollectionGGController
...
-(void)GetHttpData
{
    ...
    NSString *url =[NSString stringWithFormat:@"%@/client/act/advert/favorite/query",LocalHostm];
