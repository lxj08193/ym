...
@interface CollectionSJController ()

@end

@implementation CollectionSJController
...
-(void)GetHttpData
{
    ...
    NSString *url =[NSString stringWithFormat:@"%@/client/act/comsumer/favorite/shop/query",LocalHostm];
